...
class Tracker {
 public:
  ...
  /*void StartSavingCoordinates(
      const std::filesystem::path &save_directory_coordinates);
  void StopSavingCoordinates();
  void set_save_coordinates(bool save_coordinates);
  void set_save_directory_coordinates(
      const std::filesystem::path &save_directory_coordinates);*/
  ...
  void PrintModelCoordinatesAndRotation();
  //void SaveCoordinatesToCSV();
  ...
  bool set_up() const;
  /*bool save_coordinates() const;
  const std::filesystem::path &save_directory_coordinates() const;*/
 ...
 private:
  ...
  int viewer_time_ = 1;
  /*bool save_coordinates_ = false;
  std::filesystem::path save_directory_coordinates_{};*/
