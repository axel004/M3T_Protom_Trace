...
void ImageColorViewer::DrawLine(Eigen::Vector3f &start_point,
                                Eigen::Vector3f &end_point,
                                const Intrinsics &intrinsics) {
  //cv::Point2d punto_iniziale(start_point.x(), start_point.y());
  //cv::Point2d punto_finale(end_point.x(), end_point.y());
...
void ImageDepthViewer::DrawLine(Eigen::Vector3f &start_point,
                                Eigen::Vector3f &end_point,
                                const Intrinsics &intrinsics) {
