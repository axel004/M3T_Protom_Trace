...
int main(int argc, char *argv[]) {
  ...
  const std::filesystem::path color_camera_metafile_path{"C:/Users/Alessandro Rastelli/Desktop/squirrel/loaderColorCamera.yaml"};
  const std::filesystem::path body_metafile_path{"C:/Users/Alessandro Rastelli/Desktop/squirrel/body.yaml"};
  const std::filesystem::path detector_metafile_path{"C:/Users/Alessandro Rastelli/Desktop/squirrel/manualdetector.yaml"};
  const std::filesystem::path temp_directory{"C:/Users/Alessandro Rastelli/Desktop/squirrel/test"};
  ...
  std::cout << color_camera_metafile_path << std::endl;  
  ...
  auto body_ptr{std::make_shared<m3t::Body>("squirrel", body_metafile_path)};
  renderer_geometry_ptr->AddBody(body_ptr);
  std::cout << body_metafile_path << std::endl;  
  std::cout << body_ptr << std::endl;  
  ...
  std::cout << temp_directory << std::endl;  
  ...
  std::cout << region_modality_ptr << std::endl;  
  ...
  std::cout << detector_metafile_path << std::endl;  
  std::cout << detector_ptr << std::endl;  
